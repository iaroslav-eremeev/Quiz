...
public class Main extends Application {
    ...
    //TODO Нужно сделать чтобы при нажатии на кнопку Save викторина сохранялась в файл csv или json
    //TODO а также ЗАШИФРОВАТЬ ответы перед сохранением!
    //TODO Вопросы нужно расшифровать с помощью URLDecoder - что это вообще?
